...
const AboutSection = () => {
  ...
  return (
    ...
    >
      ...
      <Button className='text-md lg:text-lg shadow-xl  mx-auto w-[200px] mt-[-30px] lg:mt-[-130px] bg-gray-900 hover:bg-gray-900/80 hover:text-gray-100 transition duration-1000' onClick={handleButtonClick} >Créer une étreinte</Button>
